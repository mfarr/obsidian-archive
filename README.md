...
- Set the auto-archive frequency and optionally click "Auto Archive Now" to run immediately.
...
- **New**: Add auto-archive rules with scheduled processing, conditions, and a settings UI.
